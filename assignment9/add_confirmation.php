...
if ( !isset($_POST['title']) || empty($_POST['title']) ) {
	...
	$user = "bartecki_assignment10";
	$password = "TestPasswordITP303";
	$db = "bartecki_dvd_db";
	...
	// Double check optional values by making them null 
	...
	// to deal w quotes for sql injection attacks
	$title = $mysqli->real_escape_string($_POST["title"]);

	$sql  = "INSERT INTO dvd_titles(title, release_date, award, label_id, sound_id, 
